...
if (STATE == BATTLE_STATE.TURN_PREPARATION || STATE == BATTLE_STATE.IN_TURN) {
   ...
   var soul_position = [x, y];
    ...
    if (isInside[1][0])
    {
        ...
        for (var i = limit_index[0]; i < boardcount; i++)
        {
            if (global.boards_array[i].cover && !global.boards_array[i].isCollide[0])
                continue;
    ...
    if (isInside[1][1])
    {
        ...
        for (var i = limit_index[1]; i < boardcount; i++)
        {
            if (global.boards_array[i].cover && !global.boards_array[i].isCollide[1])
                continue;
    ...
    if (isInside[1][2])
    {
        ...
        for (var i = limit_index[2]; i < boardcount; i++)
        {
            if (global.boards_array[i].cover && !global.boards_array[i].isCollide[2])
                continue;
    ...
    if (isInside[1][3])
    {
        ...
        for (var i = limit_index[3]; i < boardcount; i++)
        {
            if (global.boards_array[i].cover && !global.boards_array[i].isCollide[3])
                continue;
