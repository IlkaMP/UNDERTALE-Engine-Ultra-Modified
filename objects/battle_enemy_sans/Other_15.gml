	...
	case BATTLE_MENU_CHOICE_BUTTON.ACT:
		if Battle_GetMenuChoiceEnemy() == Battle_ConvertEnemySlotToMenuChoiceEnemy(_enemy_slot)
		{
		    switch (Battle_GetMenuChoiceAction())
			{
		        ...
		        case 0:
					//act1
					Dialog_Add(variable_instance_get(self, "acttext"+string(1)));
		            break;

		        case 1:
		            //act2
		            Dialog_Add(variable_instance_get(self, "acttext"+string(2)));
		            break;

		        case 2:
		            // act3
		            Dialog_Add(variable_instance_get(self, "acttext"+string(3)));
					break;
				case 3:
		            // act4
		            Dialog_Add(variable_instance_get(self, "acttext"+string(4)));
					break;
				case 4:
		            // act5
		            Dialog_Add(variable_instance_get(self, "acttext"+string(5)));
					break;
				case 5:
		            // act6
		            Dialog_Add(variable_instance_get(self, "acttext"+string(6)));
					break;
		    }
		}
			break;
