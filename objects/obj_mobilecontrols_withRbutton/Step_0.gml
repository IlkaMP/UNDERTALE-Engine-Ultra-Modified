...
if (keyboard_check(126))
{
    var dx = mx - joy_center_x;
    var dy = my - joy_center_y;
    var dist = point_distance(joy_center_x, joy_center_y, mx, my);
    
    if (dist <= max_radius)
    {
        analog_center_x = mx - (21 * analog_scale);
        analog_center_y = my - (21 * analog_scale);
    }
    else
    {
        var dir = point_direction(joy_center_x, joy_center_y, mx, my);
