...
if (state == 4)
{
	...
	draw_sprite_ext(spr_gb_beam, 0, _beam[0], _beam[1], _blaster[4], _beam_yscale, _beam[4], _color, _beam[5]);	
	draw_sprite_ext(spr_gb_beam, 1, _beam_x, _beam_y, _beam_xscale, _beam_yscale, _beam[4], _color, _beam[5]);
	

		
}

draw_sprite_ext(_blaster[0], _blaster[1], _blaster[2], _blaster[3], _blaster[4], _blaster[5], _blaster[6], _color, _blaster[7]);
