// 直接创建一个框，创建后需要手动添加顶点
///@desc Create an Board directly, you need to add vertexes by yourself
...
//创建一个矩形的框
///@desc Create a Board that is rect
...
//创建一个圆形的框
///@desc Create a Board that is circle
...
//创建一个椭圆的框
///@desc Create a Board that is ellipse
...
//创建一个圆角矩形的框
///@desc Create a Board that is roundrect
...
///@desc Add vertex to the Board,you need to add at least 3 vertexes to make it work properly.
