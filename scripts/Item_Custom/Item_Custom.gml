function Item_Custom(){
	{
		...
		variable_instance_set(world, "bandageHeals", 10)
		itemTypes.Register(ITEM_BANDAGE, new CustomItem_Bandage());
		
		#macro ITEM_PELMENI "pelmeni"
		variable_instance_set(world, "pelmeniHeals", 5)
		itemTypes.Register(ITEM_PELMENI, new CustomItem_Pelmeni());
		...
		itemTypes.Register(ITEM_TOUGH_GLOVE, new CustomItem_ToughGlove());
